# ARCHIVED - class_name removed to prevent conflicts with active MultiMeshManager
# See scripts/systems/rendering/MultiMeshManager.gd for the active implementation
extends Node
...
var investigation_step_7_position_only: bool = true
